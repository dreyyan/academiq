...
public class PhDStudent extends GraduateStudent {
    ...
    // [METHOD: Override] Display PhD student's information
    @Override
    public void displayInfo() {
        super.displayInfo();
        System.out.println("Qualifying Exam Passed: " + (qualifyingExamPassed ? "Yes" : "No"));
        System.out.println("Dissertation Proposal Defended: " + (dissertationProposalDefended ? "Yes" : "No"));
        System.out.println("Candidacy Status: " + (candidacyStatus ? "Achieved" : "Not Achieved"));
        System.out.println("Defense Date: " + (defenseDate != null ? defenseDate : "Not Scheduled"));
        System.out.println("Publications: " + (publications.isEmpty() ? "None" : publications.size()));
    }
