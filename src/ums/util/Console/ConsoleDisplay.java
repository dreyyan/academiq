...
public class ConsoleDisplay {
    ...
    public static void displayHeaderTitle() {
        ...
        // --------------------------------------------------------------------- //
        // 1. Clear screen (ANSI escape – works in most terminals)
        // --------------------------------------------------------------------- //
        System.out.print("\033[H\033[2J");
        System.out.flush();

        // --------------------------------------------------------------------- //
        // 2. Multi‑line ASCII art for “AcademIQ”
        // --------------------------------------------------------------------- //
        String[] bigTitle = {
            "    █████╗  ██████╗ █████╗ ██████╗ ███████╗███╗   ███╗██╗ ██████╗ ",
            "   ██╔══██╗██╔════╝██╔══██╗██╔══██╗██╔════╝████╗ ████║██║██╔═══██╗",
        ...
        // --------------------------------------------------------------------- //
        // 3. Build the whole header (border + big title + subtitle + version)
        // --------------------------------------------------------------------- //
        java.util.List<String> headerLines = new java.util.ArrayList<>();
        ...
        int usedLines = headerLines.size();               // 1 + 6 + 2 + 1 = 10
        int totalPadding = HEIGHT - usedLines;
        int topPadding   = totalPadding / 2;
        int bottomPadding = totalPadding - topPadding;

        // --------------------------------------------------------------------- //
        // 4. Print everything centered
        // --------------------------------------------------------------------- //
